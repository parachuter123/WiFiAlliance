...
$("body").html('<div id="div1" class="wrapper test transition">'+
	'<h1 class="logo">'+
		'<div class="imglogo" id="imglogo">'+
			'<img src="'+BusinesLogoURL+'" height="100%" alt="'+BusinesName+'">'+
		'</div>'+
	'</h1>'+
	'<div class="notecont">'+
  	'<p>'+BusinesName+'</p>'+
	...
	'</div>'+
  '<div id="footer">'+
    '<small style="font-size:16px">已有<font style="color:#FF8080">'+RenShu+'</font>人使用本WiFi</small><br />'+
		'<small>技术支持 '+AgentName+'</small>'+
  '</div>'+
'</div>');
